...
+ (instancetype)popoverAnimatorWithStyle:(YCPopoverType )popoverType isOnClickBackground:(BOOL)isOnClickBackground backgroundColor:(UIColor *)backgroundColor completeHandle:(YCCompleteHandle)completeHandle{
    ...
    popoverAnimator.isOnClickBackground = isOnClickBackground;
    popoverAnimator.backgroundColor = backgroundColor;
...
- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source{
    ...
    presentation.isOnClickBackground = self.isOnClickBackground;
