...
- (NSDictionary *)setionHeightInWaterFlowLayout:(JHWaterfallCollectionLayout *)waterFlowLayout;

@end

@interface JHWaterfallCollectionLayout : UICollectionViewFlowLayout
/**代理*/
