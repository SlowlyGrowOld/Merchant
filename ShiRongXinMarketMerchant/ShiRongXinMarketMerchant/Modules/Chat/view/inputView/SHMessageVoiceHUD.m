...
- (void)setHudType:(SHVoiceHudType)hudType
{
    ...
    switch (hudType)
    {
        ...
        case SHVoiceHudType_cancel:
        {
            ...
            self.voiceImg.image = [UIImage imageNamed:@"voice_change"];
        }
            break;
        case SHVoiceHudType_warning:
        {
            self.messageLab.text = @"时间太短";
            self.voiceImg.image = [UIImage imageNamed:@"voice_failure"];
        }
            break;
        default:
            break;
...
- (void)showVoiceMeters:(int)meter
{
    if (self.hudType == SHVoiceHudType_recording)
    {
        ...
        self.voiceImg.image = [UIImage imageNamed:imageName];
    }
}
