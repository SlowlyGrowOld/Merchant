...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _buttonsBgView.backgroundColor = [UIColor colorWithRed:0 / 255 green:0 / 255 blue:0 / 255 alpha:0.73];
...
- (void)showViewWithButtonModels:(NSArray *)array
    ...
    if (direction == JYBubbleMenuViewDirectionPriorityType_Up) {
        ...
        _arrowView.image = [UIImage imageNamed:@"bubble_arrowDown"];
    } else {
        arrowRect.origin.x = rect.origin.x + rect.size.width / 2.0 - selfRect.origin.x - _arrowWidth / 2.0;
        arrowRect.origin.y = 0;
        _arrowView.image = [UIImage imageNamed:@"bubble_arrowUp"];
    }
