...
- (void)setupUI
{
    ...
    [_increaseBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    _textField.frame = CGRectMake(_height, 0, _width - 2*_height, _height-1);
    _lineView.frame = CGRectMake(_height+8, _height-1, _width - 2*_height-16, 1);
